...
model = joblib.load('C:\\Users\\hasib\\Desktop\\ai project\\RandomForest\\RF_model_rf.pkl')
...
# Create sequences (for consistency, although Random Forest does not require sequences)
backcandles = 30
...
y_pred_new_unscaled = y_pred_new  # As Random Forest does not alter scale
...
results.to_csv('C:\\Users\\hasib\\Desktop\\ai project\\RandomForest\\RF_actual_vs_predicted.csv', index=False)
