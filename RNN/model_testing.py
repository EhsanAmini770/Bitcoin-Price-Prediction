...
model = load_model('C:\\Users\\hasib\\Desktop\\ai project\\RNN\\RNN_model.h5', custom_objects={'mse': MeanSquaredError()})
...
results.to_csv('C:\\Users\\hasib\\Desktop\\ai project\\RNN\\RNN_actual_vs_predicted.csv', index=False)
